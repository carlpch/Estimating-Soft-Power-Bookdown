...
<img src='figure1.png' style='margin:0 auto;' width='70%'/>
...
$$
Pr(x_{rs}|\alpha_s,\beta_s,\theta_r) = \frac{esp(\alpha_s(\theta_r-\beta_s))}{1+ exp(\alpha_s(|\theta_r - \beta_s ))}
$$
where $x_rs$ indicates a diplomatic exchange from sending state $s$ to receiving state $r$. Item parameters $\alpha_s$ and $\beta_s$ represent the discrimination and difficulty parameter of $s$. The person parameter $\theta_r$ is our goal of measurement: the diplomatic appeal of $r$. 

## Results

### Ranking of Diplomatic Appeals (Persons Location)
...
<img src='figure2.png' style='margin:0 auto;'/>
...
<img src='figure3.png' style='margin:0 auto;'/>
...
Table: Table 2. Item Fit Statistics, Diplomatic Exchange Data (2005)
...
Table: Table 3. Mis-fitted Items (2005)
...
Table: Table 4. Mis-fitted Persons (2005)
...
Embretson, Susan E. and Steven P. Reise. (2000) *Item Response Theory for Psychologists*. Mahwah, NJ: Lawrence Erlbaum Associates, Inc., Publishers.

Erbacher, Monica K., Karen M. Schmidt, Steven M. Boker, and Cindy S. Bergeman. (2013) “Measuring Positive and Negative Affect in Older Adults Over 56 Days: Comparing Trait Level Scoring Methods Using the Partial Credit Model,” *Journal of Applied Measurement*, 13(2), 146-164.

Neumayer, E. (2008) “Distance, Power and Ideology: Diplomatic Representation in a World of Nation-States.” *Area*, Vol. 40, No. 2, pp. 228–236.

Kinne, B.J. (2014) “Dependent Diplomacy: Signaling, Strategy, and Prestige in the Diplomatic Network.” *International Studies Quarterly*, Vol. 58, pp. 247–259.
...
Pant, S. (2008) *History of India’s Diplomatic Missions: Formative Years*. Delhi: Shakti Book House.

Rich, T.S. (2009) “Status for Sale: Taiwan and the Competition for Diplomatic Recognition.” *Issues & Studies*, Vol 45, No. 4, pp. 159-188.
Singer, D., and Small, M. (1966) “The Composition and Status Ordering of the International System: 1815-1940.” *World Politics*, Vol. 18, No. 2, pp. 236-282. 

Simmons, B.A. (2009) *Mobilizing for Human Rights: International Law in Domestic Politics.* Combridge: Cambridge University Press.
